...
if(isset($_POST['submit'])){
      ...
      $num = $_POST['num'];
       ...
       $quer = "SELECT * FROM exam2 WHERE cata = '{$cat}' order by id desc";
   ...
   if(isset($_POST['sub'])){
    ...
    $query ="INSERT INTO relation2(user_id,exam_name,marks)" ;
...
<head>
    <title>Document</title>
      <link rel="stylesheet" type="text/css" href="style_exam3.css">
</head>
<body>
    <div class="div">
     
<p>Choose Catagory : </p>&nbsp<form action = "exam3.php" method ="POST" >
        <select name="dc">
    ...
    <br>
    <form action= "exam3.php" method="POST" class= "sim">
        <p>Enter the amount of the questions in the paper : </p>
         <?php echo "<input type='int' name='num' placeholder='Enter a integer number ' required>";?><br>
        <?php echo "<input type='submit' name='submit' value='submit to choose'>";?><br>
    </form>
   <form action= "exam3.php" method="POST" class= "simple">
<?php 
while($i>0){
?>
