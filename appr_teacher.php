...
$query = "SELECT * FROM register WHERE cata = '{$admin}' and  checkk = '{$pending}'";
...
<table border="10">
    ...
    if($sql == "APPROVE"){
       echo "yes";  
        ...
        header("Location: ..//project%202/appr_teacher.php"); 
        }
    ?>   
   </form>
 </div>
    </header>
    <a href="main_admin.php" >GO back!</a>
